...
//    private List<User> usersList;
    ...
    public Flight(Long id, String airline, Double price, String departureAirport, String departureCity, String arrivalAirport, String arrivalCity, int layoverCount, LocalDateTime arrivalTime, String duration, LocalDateTime departureTime, Boolean isBooked, Integer seat) {
        this.id = id;
